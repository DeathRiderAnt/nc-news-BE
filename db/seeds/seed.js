...
const seed = ({ topicData, userData, articleData, commentData }) => {
  ...
  return db.query("DROP TABLE IF EXISTS comments")
    ...
    .then(() => {return db.query("CREATE TABLE comments (comment_id SERIAL PRIMARY KEY, article_id INT REFERENCES articles(article_id), body TEXT, votes INT DEFAULT 0, author VARCHAR(50) REFERENCES users(username), created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);")})
